...
async def start_handler(_, event: Message):
	await event.reply_photo("https://telegra.ph/file/19eeb26fa2ce58765917a.jpg",
					...
					[InlineKeyboardButton('❤ JOIN NOW', url='https://t.me/onlinedayro1')],
					[InlineKeyboardButton("Updates 𝙲𝚑𝚊𝚗𝚗𝚊𝚕", url="https://t.me/onlinedayro1")],
        ...
        if "About_msg" in cb_data:
			...
			reply_markup=InlineKeyboardMarkup(
				[
					...
					[
					InlineKeyboardButton("JOIN NOW", callback_data="Help_msg"),
					InlineKeyboardButton("About", callback_data="About_msg")
					]
				]
			),
